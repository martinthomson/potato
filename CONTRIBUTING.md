...
Discussion of this work occurs on the [Protocol for Transposed Transactions over HTTP
Working Group mailing list](mailto:ptth@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/ptth/),
[subscribe](https://mailman3.ietf.org/mailman3/lists/ptth.ietf.org/)).
...
[Working Group documents](https://datatracker.ietf.org/wg/ptth/documents/).
